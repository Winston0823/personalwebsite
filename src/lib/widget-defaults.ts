...
export const defaultWidgets: WidgetInstance[] = [
  ...
  { id: "nowPlaying-1", type: "nowPlaying", position: { col: 11, row: 0 }, size: { cols: 4, rows: 1 } },
  ...
  { id: "hiking-1", type: "hiking", position: { col: 6, row: 5 }, size: { cols: 4, rows: 2 } },
  { id: "contact-1", type: "contact", position: { col: 10, row: 4 }, size: { cols: 3, rows: 2 } },
  { id: "projects-1", type: "projects", position: { col: 0, row: 5 }, size: { cols: 4, rows: 3 } },
